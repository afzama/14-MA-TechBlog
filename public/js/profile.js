const newFormHandler = async (event) => {
  ...
  try {
    const blogTitle = document.querySelector('#blogpostData-title').value.trim();
    const blogContent = document.querySelector('#blogpostData-post_text').value.trim();
...
const editFormHandler = async (event) => {
  ...
  try {
    const id = document.querySelector('#edit-blogpostData-id').value;
    const updatedTitle = document.querySelector('#edit-blogpostData-title').value.trim();
    const updatedContent = document.querySelector('#edit-blogpostData-post_text').value.trim();
